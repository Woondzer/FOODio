...
function SearchBar({ onSearch }) {
  ...
  //search autofocus, bara börja skriva direkt
  useEffect(() => {
  ...
  return (
    <div className="flex items-center w-[90vw] max-w-[900px] mx-auto justify-center">
      <button
        className="btn btn-xl bg-green-800 hover:bg-green-900 text-white rounded-l-lg rounded-r-none px-6 focus:outline-none focus:ring-0 border-none"
      ...
      <label className="input input-xl flex items-center w-full rounded-r-lg rounded-l-none bg-white focus-within:outline-none focus-within:ring-0 border-none">
        ...
        <svg
          className="h-[1em] opacity-50 ml-2 text-gray-500"
